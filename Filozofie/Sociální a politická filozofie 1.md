...
_PHBS_
<!-- Socpol - Normativní disciplína 
- what rule or principle should govern the distribution of goods?
- kdo má majetek (a práva) - otázka spravedlnosti
- the English translate their ignorance into Greek and call it agnosticism', said Engels) --> 
...
<!-- "Those who prefer not to participate will find their political decisions made for them, whether they like it or not." - Wolff -->
...
#### Námitky k Hobbsově PS
1. lidé nejsou tak krutí
	-> nejsou krutí, ale strach znemožňuje důvěru, bez důvěry se spolupráce hroutí

2. námitka – lidé se řídí morálkou i bez zákonů
	-> v přirozeném stavu morálka neexistuje
...
> [!NOTE] Nedělitelná moc u Hobbese
> Může být libovolný počet panovníků, ale Hobbes preferuje jednoho, protože je jednotný a neroztříštěný ve svých politických rozhodnutích. Nedělitelnost autority znamená, že autorita musí vystupovat jako celek.
...
Každý má právo vymáhat, každý je autorita -> právo na majetek
...
<!-- Podle Caseyho je bojkotování nenásilnou formou (jakože libertarianistické) dost way to go, except tohle je hodně kluzký svah. Vezmeme-li v potaz třeba "Trumpův mírumilovný protest z 6. 1. 2022", tak hranice mezi organizování mírumilovného a nemírumilovného protestu je pochybná.-->
...
***
# Svoboda
<!-- to avoid the 'tyranny of the majority'! we should be given the liberty to act just as
...
1) **princip svobody** a rovnosti (nejdůležitější) - všichni mají právo na stejné svobody slučitelné se svobodami ostatních
2) **princip maximin** - všechny nerovnosti musí být pro prospěch těch, co mají nejméně blaha (princip diference) a měly by být spojeny s úřady a postaveními, k nimž má každý přístup (princip rovnosti šancí)
...
Nozick: lidé jsou tedy sebevlastníci, vlastním svoje tělo a dle Locka mám právo jak na něj, tak na produkty vlastní práce. Daně jsou otroctví, porušení práva na sebevlastnictví, forma nucené práce.

Stát je **ok**, ale jenom pokud má roli *nočního strážníka*:
- policie a armáda na ochranu před světem
- policie na ochranu soukromého majetku, ale ne příliš vysoké daně
...
<!-- The state violates individual rights to property if it attempts to transfer property from some (the rich) to others (the poor). Redistribution is to be left to the unimpeded free market, gifts, and voluntary charitable donations. -->

Společenská smlouva, ale na rozdíl od Rawlse práva ještě před smlouvou
...
> "Můj minimální stát je utopie." - Nozick
...
| pro-individualistická                             | pro-státní (sociálně demokratická) |
| ------------------------------------------------- | ---------------------------------- |
